...
### Startup files
	...
	| /etc/bash.bashrc	| name of display, if running in graphical environment (usually `:0`, meaning first generated by X server)		|
	| ~/.bashrc			| name of display, if running in graphical environment (usually `:0`, meaning first generated by X server)		|
